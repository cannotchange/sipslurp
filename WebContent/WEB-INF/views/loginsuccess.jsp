...
<!-- Brand and toggle get grouped for better mobile display -->
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="#" style="color:white;">Holy Place.in</a>
		</div>
<!-- Collect the nav links, forms, and other content for toggling -->
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul class="nav navbar-nav side-nav head-list action">
				<li class="active"><a href="${user.usertype}.do"> Home</a></li>
      
                    <li>
                        <a href="alltemple.do" class="active">Temples</a>
                    </li> 
                    <li>
                        <a href="#">Events<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="allevents.do">All Events</a>
                            </li>
                     ...
                     <li>
                        <a href="#"><i class="fa fa-sitemap fa-fw"></i>Facilities<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                      ...
                      <li>
                        <a href="#"><i class="fa fa-sitemap fa-fw"></i>Online Services<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="#">Live Darshana</a>
                                <a href="#">Seva Amount</a>
                                <a href="#"></a>
