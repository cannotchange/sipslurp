...
<script type="text/javascript" src="Scripts/Controllers/itemsCtrl.js"></script>
				...
				<div id="page-sidebar-wrapper">
					...
					<div id="sidebar-menu">
						<ul>
							...
							<ul>
									<li><a href="page-blank.html" title="Page blank"><span>Coming Soon<!-- Total Users --></span></a></li>
				...
				<div class="row">
					<div class="panel-box col-md-12">
						<div class="panel-content bg-white">
							<h3><i class="fa fa-cutlery" aria-hidden="true"></i> &nbsp;Products Management</h3>					
						</div>
					</div>
				</div>
					<div class="row">
					...
					<button ng-click="showTableAdd()" class="btn btn-primary hvr-float-shadow" style="top: 20px;position: relative;background: #2b90d9;!important"><i class="fa fa-plus" aria-hidden="true"></i> &nbsp;Add Product</button>
					<div  class="panel-box row col-md-12" style="margin-top:15px;">
						<!-- id="tabdetails" --><table datatable="ng"  style="border: 1px solid gainsboro;min-width: 103%;max-width:103%;!important" class="table table-hover">
							...
							<tbody>
							<tr ng-repeat="items in totalItems">
							<td>{{$index+1}}</td>
							<td class="it_name">{{items.itemName}}</td>
							<td class="it_created">{{items.created}}</td>
							<td class="it_orice">{{items.itemPrice}}</td>
							<td class="it_type">{{items.type}}</td>
							<!-- <td><div ng-click="pununpub(items.tableId,this,$index)" ng-class="items.style">{{items.operations}}</div></td> -->
							<td><div style="display:inline-block;" ng-click="edit_item(items.itemCode)" class="edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;Edit</div>&nbsp;&nbsp<div style="display:inline-block;" ng-click="delete_item(items.itemCode,$index)" class="delete"><i class="fa fa-trash-o" aria-hidden="true"></i>&nbsp;Delete</div></td>
