...
<html>
<head>
<title>Supina - The Ultimate Admin/Frontend Template</title>
...
<link rel="shortcut icon"
	href="resourcs/assets-minified/images/icons/favicon.png">
...
<body>
			...
			<div id="page-header" class="clearfix">
				<div id="header-logo" class="rm-transition">
					<a href="#" class="tooltip-button hidden-desktop"
						...
						class="glyph-icon icon-align-justify"></i></a> <span>Supina
						Admin <i class="opacity-80">1.0</i>
					</span> <a id="collapse-sidebar" href="#" title=""><i
						class="glyph-icon icon-chevron-left"></i></a>
				</div>
				<div id="sidebar-search">
					<input type="text" placeholder="Search..."
						class="autocomplete-input input tooltip-button"
						data-placement="bottom"
						title="Type &apos;jav&apos; to see the available tags..." id=""
						name=""> <i class="glyph-icon icon-search"></i>
				</div>
				<div id="header-right">
						...
						<div class="dropdown-menu pad0B float-right">
							<div class="box-sm">
								...
								<div class="pad5A button-pane button-pane-alt text-center">
									<a href="#" class="btn display-block font-normal btn-danger"><i
						...
						<ul>
							...
							<ul>
									...
									<li><a href="featured-area-1.html" title="Hero area 1"><span>Hero
												area 1</span></a></li>
									<li><a href="featured-area-2.html" title="Hero area 2"><span>Hero
												area 2</span></a></li>
									<li><a href="featured-area-3.html" title="Hero area 3"><span>Hero
												area 3</span></a></li>
									<li><a href="featured-area-4.html" title="Hero area 4"><span>Hero
												area 4</span></a></li>
									<li><a href="featured-area-5.html" title="Hero area 5"><span>Hero
												area 5</span></a></li>
									<li><a href="featured-area-6.html" title="Hero area 6"><span>Hero
												area 6</span></a></li>
									<li><a href="featured-area-7.html" title="Hero area 7"><span>Hero
												area 7</span></a></li>
									<li><a href="featured-area-8.html" title="Hero area 8"><span>Hero
												area 8</span></a></li>
									<li><a href="featured-area-9.html" title="Hero area 9"><span>Hero
												area 9</span></a></li>
									<li><a href="featured-area-10.html" title="Hero area 10"><span>Hero
												area 10</span></a></li>
									<li><a href="featured-area-11.html" title="Hero area 11"><span>Hero
												area 11</span></a></li>
									<li><a href="featured-area-12.html" title="Hero area 12"><span>Hero
												area 12</span></a></li>
									<li><a href="featured-area-13.html" title="Hero area 13"><span>Hero
												area 13</span></a></li>
									<li><a href="featured-area-14.html" title="Hero area 14"><span>Hero
												area 14</span></a></li>
									<li><a href="featured-area-15.html" title="Hero area 15"><span>Hero
												area 15</span></a></li>
									<li><a href="featured-area-16.html" title="Hero area 16"><span>Hero
												area 16</span></a></li>
							...
							<ul>
									...
									<li><a href="mailbox-inbox-alt.html"
										title="Inbox alternate"><span>Inbox alternate</span></a></li>
									<li><a href="mailbox-compose.html" title="Compose message"><span>Compose
												message</span></a></li>
									<li><a href="mailbox-message.html" title="View message"><span>View
												message</span></a></li>
								</ul>
								<ul>
							...
							<ul>
									...
									<li><a href="page-blank.html" title="Page blank"><span>Page
												blank</span></a></li>
							...
							<ul>
									...
									<li><a href="index.html" title="Dashboard example 1"><span>Dashboard
												example 1</span></a></li>
			...
			<div id="page-content-wrapper" class="rm-transition">
				<div id="page-nav">
					<div class="dropdown sp-btn">
						<a href="#" class="btn btn-primary popover-button"
					...
					<ul id="page-subnav">
						<li><a href="resourcs/production/social-boxes.html"
							title="Social boxes"><span>Social boxes</span></a></li>
						<li><a href="resourcs/production/spinners.html"
							title="Loading spinners"><span>Loading spinners</span></a></li>
						<li><a href="resourcs/production/tile-boxes.html"
							title="Tile boxes"><span>Tile boxes</span></a></li>
						<li><a href="resourcs/production/timeline.html" title="Timeline"><span>Timeline</span></a></li>
					</ul>
					<div id="page-nav-right">
						<a href="#" title=""
							class="btn sb-open-right no-shadow updateEasyPieChart"><i
							class="glyph-icon icon-cogs"></i> Statistics</a> <a href="#" title=""
							...
							<div class="tile-box tile-box-alt bg-blue">
								...
								<div class="tile-content-wrapper">
									...
									<div class="tile-content">
										<i class="glyph-icon icon-caret-up font-red"></i> 185
									</div>
									<small><i class="glyph-icon icon-caret-up"></i> +7,6%
										email list penetration</small>
								</div>
						...
						<div class="col-md-4">
							<div class="tile-box tile-box-alt bg-green">
								...
								<div class="tile-content-wrapper">
									...
									<div class="tile-content">
										<i class="glyph-icon icon-arrow-up font-green"></i> 6.52 <span>k</span>
									</div>
									<small>12% have started the download</small>
								</div>
								<a href="#" title="" class="tile-footer">view details <i
									class="glyph-icon icon-arrow-right"></i></a>
							</div>
						...
						<div class="col-md-4">
							<div class="tile-box tile-box-alt bg-red" title="">
								...
								<div class="tile-content-wrapper">
									...
									<small><i class="glyph-icon icon-caret-up"></i> $272
										daily revenue from all sales</small>
								</div>
								<a href="#" title="" class="tile-footer">view details <i
									class="glyph-icon icon-arrow-right"></i></a>
							</div>
						...
						<div class="col-md-8">
							...
							<div class="content-box mrg25T mrg25B">
								<h3 class="content-box-header content-box-header-alt bg-white">
									<span class="icon-separator"><i
										class="glyph-icon icon-cog"></i></span>
									<div class="header-wrapper">
										Content title <small>Example header title description</small>
									</div>
											...
											<div class="tl-item">
												...
												<div class="popover left">
													...
													<div class="popover-content">
														...
														<p class="tl-content">Quisque volutpat mattis eros.
							...
							<div class="panel-layout">
								...
								<div class="panel-box col-xs-8">
									...
									<div class="panel-content bg-white">
										<div class="center-vertical">
											<ul class="center-content nav nav-justified">
												<li><h4 class="font-green">+$39,45</h4>
													<p class="font-gray">Overdue orders</p></li>
												<li><h4>
														<i class="glyph-icon opacity-60 icon-caret-up"></i> 217
													</h4>
													<p class="font-gray">Pending orders</p></li>
											</ul>
										</div>
									</div>
								</div>
								...
								<div class="col-md-12">
										...
										<div class="panel-box">
											<div class="panel-content bg-white">
												<div class="">
													...
													<h5 class="font-bold">Johnny Anderson</h5>
												</div>
											</div>
											<div class="panel-content pad15A bg-white">
												<div class="center-vertical">
										...
										<div class="panel-box">
											<div class="panel-content image-box">
												<div class="corner-ribbon">
													<a href="#" class="btn-success" title=""><i
														class="glyph-icon icon-comment-o"></i></a>
												</div>
												...
												<img
													src="resourcs/assets-minified/dummy-images/455293175_1280.jpg"
													alt="">
											</div>
											<div class="panel-content pad0A bg-white">
												<div class="meta-box meta-box-offset">
													...
													<h4 class="meta-subheading font-size-13 font-gray">Ultimate
														backend programmer</h4>
												</div>
													...
													<tbody>
														<tr>
															...
															<td style="width: 50%"><div
																	class="progressbar-small progressbar" data-value="95">
																	<div class="progressbar-value bg-red tooltip-button"
																		title="95%"></div>
																</div></td>
														</tr>
														<tr>
															...
															<td style="width: 50%"><div
																	class="progressbar-small progressbar" data-value="45">
																	<div class="progressbar-value bg-azure tooltip-button"
																		title="45%"></div>
																</div></td>
														</tr>
														<tr>
															...
															<td style="width: 50%"><div
																	class="progressbar-small progressbar" data-value="85">
																	<div class="progressbar-value bg-green tooltip-button"
																		title="85%"></div>
																</div></td>
														</tr>
														<tr>
															...
															<td style="width: 50%"><div
																	class="progressbar-small progressbar" data-value="75">
																	<div class="progressbar-value bg-yellow tooltip-button"
																		title="45%"></div>
																</div></td>
														</tr>
														<tr>
															...
															<td style="width: 20%"><div
																	class="progressbar-small progressbar" data-value="20">
																	<div class="progressbar-value bg-blue tooltip-button"
																		title="20%"></div>
																</div></td>
														</tr>
														<tr>
															<td class="text-left"><b>Skills</b></td>
															<td style="width: 87%"><div
																	class="progressbar-small progressbar" data-value="87">
																	<div class="progressbar-value bg-orange tooltip-button"
																		title="87%"></div>
																</div></td>
														</tr>
													</tbody>
									...
									<div class="dashboard-box bg-white content-box mrg25T">
										<div class="content-wrapper">
											<div class="header">
												Monthly evolution <span>July - December 2013</span>
											</div>
										...
										<div class="button-pane">
											<div class="size-md float-left heading">Overdue orders</div>
											<a href="#" class="btn btn-info float-right tooltip-button"
												data-placement="top" title=""
												data-original-title="Remove comment"><i
	...
	<div class="sb-slidebar sb-left sb-style-overlay">
		<div class="scrollable-content scrollable-nice">
			...
			<ul class="chat-box">
				<li><div class="status-badge">
						<img class="img-circle" width="40"
							src="resourcs/assets-minified/dummy-images/people/testimonial1.jpg"
							alt="">
				...
				<li><div class="status-badge">
						<img class="img-circle" width="40"
							src="resourcs/assets-minified/dummy-images/people/testimonial2.jpg"
							alt="">
						<div class="small-badge bg-green"></div>
					</div>
					<b>Carl Gamble</b>
				...
				<li><div class="status-badge">
						<img class="img-circle" width="40"
							src="resourcs/assets-minified/dummy-images/people/testimonial4.jpg"
							alt="">
						<div class="small-badge bg-green"></div>
					</div>
					<b>Bill Green</b>
				...
				<li><div class="status-badge">
						<img class="img-circle" width="40"
							src="resourcs/assets-minified/dummy-images/people/testimonial5.jpg"
							alt="">
						<div class="small-badge bg-green"></div>
					</div>
					<b>Cheryl Soucy</b>
			...
			<ul class="chat-box">
				<li><div class="status-badge">
						<img class="img-circle" width="40"
							src="resourcs/assets-minified/dummy-images/people/testimonial6.jpg"
							alt="">
				...
				<li><div class="status-badge">
						<img class="img-circle" width="40"
							src="resourcs/assets-minified/dummy-images/people/testimonial7.jpg"
							alt="">
						<div class="small-badge bg-orange"></div>
					</div>
					<b>Dan Garcia</b>
				...
				<li><div class="status-badge">
						<img class="img-circle" width="40"
							src="resourcs/assets-minified/dummy-images/people/testimonial8.jpg"
							alt="">
						<div class="small-badge bg-orange"></div>
					</div>
					<b>Edward Bridges</b>
	...
	<div class="sb-slidebar sb-right sb-style-overlay">
		<div class="scrollable-content scrollable-nice">
			...
			<div id="sidebar-toggle-6" class="collapse in">
				<ul class="files-box">
					...
					<div class="files-content">
						...
						<div class="files-buttons">
							<a href="#"
								class="btn btn-md no-border radius-all-100 hover-info tooltip-button"
								data-placement="right" title="Download"><i
								class="glyph-icon icon-cloud-download"></i></a> <a href="#"
								class="btn btn-md no-border radius-all-100 hover-danger tooltip-button"
								data-placement="right" title="Delete"><i
								class="glyph-icon icon-times"></i></a>
						</div></li>
					<li class="divider"></li>
			...
			<div class="clear"></div>
			<a href="#" title="" data-toggle="collapse"
				data-target="#sidebar-toggle-3" class="popover-title">Tasks for
