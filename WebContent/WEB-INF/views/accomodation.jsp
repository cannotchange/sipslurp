...
<link rel="apple-touch-icon-precomposed" sizes="144x144"
	href="../assets-minified/images/icons/apple-touch-icon-144-precomposed.png">
<link rel="apple-touch-icon-precomposed" sizes="114x114"
	href="../assets-minified/images/icons/apple-touch-icon-114-precomposed.png">
<link rel="apple-touch-icon-precomposed" sizes="72x72"
	href="../assets-minified/images/icons/apple-touch-icon-72-precomposed.png">
<link rel="apple-touch-icon-precomposed"
	href="../assets-minified/images/icons/apple-touch-icon-57-precomposed.png">
<link rel="shortcut icon"
	href="../assets-minified/images/icons/favicon.png">
...
<link rel="stylesheet" type="text/css"
	href="../assets-minified/helpers/helpers-all.css">
<link rel="stylesheet" type="text/css"
	href="../assets-minified/elements/elements-all.css">
<link rel="stylesheet" type="text/css"
	href="../assets-minified/icons/fontawesome/fontawesome.css">
<link rel="stylesheet" type="text/css"
	href="../assets-minified/icons/linecons/linecons.css">
<link rel="stylesheet" type="text/css"
	href="../assets-minified/snippets/snippets-all.css">
<link rel="stylesheet" type="text/css"
	href="../assets-minified/applications/mailbox.css">
<link rel="stylesheet" type="text/css"
	href="../assets-minified/themes/supina/layout.css">
<link id="layout-color" rel="stylesheet" type="text/css"
	href="../assets-minified/themes/supina/default/layout-color.css">
<link id="framework-color" rel="stylesheet" type="text/css"
	href="../assets-minified/themes/supina/default/framework-color.css">
<link rel="stylesheet" type="text/css"
	href="../assets-minified/themes/supina/border-radius.css">
<link rel="stylesheet" type="text/css"
	href="../assets-minified/helpers/colors.css">
</head>
<body>
	<div id="loading">
		<img src="../assets-minified/images/spinner/loader-dark.gif"
			alt="Loading...">
	</div>
	<div id="sb-site">
		<div id="page-wrapper">
				...
				<div id="header-right">
					<div class="user-profile dropdown">
						<a href="#" title="" class="user-ico clearfix"
							...
							src="../assets-minified/dummy-images/gravatar.jpg" alt="">
			...
			<div id="page-content-wrapper" class="rm-transition">
				<div id="page-nav">
					...
					<ul id="page-subnav">
						<li><a href="../production/social-boxes.html"
							title="Social boxes"><span>Social boxes</span></a></li>
						<li><a href="../production/spinners.html"
							title="Loading spinners"><span>Loading spinners</span></a></li>
						<li><a href="../production/tile-boxes.html"
							title="Tile boxes"><span>Tile boxes</span></a></li>
						<li><a href="../production/timeline.html" title="Timeline"><span>Timeline</span></a></li>
					</ul>
				...
				<div id="page-content">
					<div class="page-box">
						<h3 class="page-title">
							Tables <small>View all kinds of Tables examples below.</small>
						</h3>
						<h2 class="title-hero">Tables</h2>
						<p class="title-lead">Our framework comes packed with a lot of
							table options variations.</p>
						<div class="divider"></div>
						<h3 class="title-hero">Basic structure</h3>
						<p class="title-lead">
							To apply the basic table styling you need to add the
							<code>.table</code>
						...
						<h3 class="title-hero">Condensed table</h3>
						<p class="title-lead">
							To create a condensed table add the
						...
						<h3 class="title-hero">Bordered table</h3>
						<p class="title-lead">
							To create a bordered table add the
						...
						<h3 class="title-hero">Striped table</h3>
						<p class="title-lead">
							To create a striped-row table add the
						...
						<h3 class="title-hero">Hover table rows</h3>
						<p class="title-lead">
							To create hover table rows add the
						...
						<h3 class="title-hero">Responsive tables</h3>
						<p class="title-lead">
							To create a basic responsive table wrap the
							<code>.table</code>
							element inside a div with the
	...
	<div class="sb-slidebar sb-left sb-style-overlay">
		<div class="scrollable-content scrollable-nice">
			...
			<ul class="chat-box">
				<li><div class="status-badge">
						<img class="img-circle" width="40"
							src="../assets-minified/dummy-images/people/testimonial1.jpg"
							alt="">
				...
				<li><div class="status-badge">
						<img class="img-circle" width="40"
							src="../assets-minified/dummy-images/people/testimonial2.jpg"
							alt="">
						<div class="small-badge bg-green"></div>
					</div>
					<b>Carl Gamble</b>
				...
				<li><div class="status-badge">
						<img class="img-circle" width="40"
							src="../assets-minified/dummy-images/people/testimonial3.jpg"
							alt="">
						<div class="small-badge bg-green"></div>
					</div>
					<b>Michael Poole</b>
				...
				<li><div class="status-badge">
						<img class="img-circle" width="40"
							src="../assets-minified/dummy-images/people/testimonial4.jpg"
							alt="">
						<div class="small-badge bg-green"></div>
					</div>
					<b>Bill Green</b>
				...
				<li><div class="status-badge">
						<img class="img-circle" width="40"
							src="../assets-minified/dummy-images/people/testimonial5.jpg"
							alt="">
						<div class="small-badge bg-green"></div>
					</div>
					<b>Cheryl Soucy</b>
			...
			<ul class="chat-box">
				<li><div class="status-badge">
						<img class="img-circle" width="40"
							src="../assets-minified/dummy-images/people/testimonial6.jpg"
							alt="">
				...
				<li><div class="status-badge">
						<img class="img-circle" width="40"
							src="../assets-minified/dummy-images/people/testimonial7.jpg"
							alt="">
						<div class="small-badge bg-orange"></div>
					</div>
					<b>Dan Garcia</b>
				...
				<li><div class="status-badge">
						<img class="img-circle" width="40"
							src="../assets-minified/dummy-images/people/testimonial8.jpg"
							alt="">
						<div class="small-badge bg-orange"></div>
					</div>
					<b>Edward Bridges</b>
	...
	<link rel="stylesheet" type="text/css"
		href="../assets-minified/demo-widgets.css">
